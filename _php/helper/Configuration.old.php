...
class Configuration
{
	...
	public function __construct(){
		//all default value
		$this->project_name     = "INFORMASI KUALITAS LINGKUNGAN HIDUP PROVINSI SUMATERA UTARA";
		$this->base_url         = "project/dlh/";
		$this->assets_dir       = "../../../_assets/";
		$this->sessionAdmin     = "session-".$this->project_name."-admin";
		$this->sessionUser      = "session-".$this->project_name."-user";
	}
